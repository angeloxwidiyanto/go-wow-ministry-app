...
export default function CreateEventClient({ parentEvents = [] }: { parentEvents?: { id: string, title: string }[] }) {
  ...
  const [blocks, setBlocks] = useState<{ id: number, type: string, content: string }[]>([]);
  ...
  return (
    <div className="max-w-3xl pb-20">
      <header className="mb-10">
        ...
        <h1 className="text-4xl font-headline text-zinc-900 mb-2">Create New Event</h1>
        <p className="text-zinc-500 font-body">Set up the details and design the landing page for your upcoming event.</p>
      </header>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              ...
              <input 
                ...
                type="text" 
                className="w-full px-4 py-3 bg-zinc-50 border border-zinc-200 rounded-xl text-sm focus:ring-2 focus:ring-primary/20 focus:bg-white outline-none transition-colors" 
                placeholder="e.g. Easter Sunday Celebration 2024" 
              />
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex items-center">
                ...
                <input 
                  ...
                  placeholder="easter-sunday-2024" 
                />
              </div>
              <p className="text-xs text-zinc-500 mt-2">This is the link you will share with the congregation to register.</p>
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <textarea 
                ...
                placeholder="Tell attendees briefly what to expect..." 
              />
            </div>
                ...
                {blocks.map((block, idx) => (
                  <div key={block.id} className="p-4 border border-zinc-200 rounded-xl bg-zinc-50 relative group">
                    ...
                    <textarea 
                      ...
                      placeholder={block.type === 'text' ? "Write additional details, schedule, or instructions here..." : "Write a highlight quote..."}
                    />
                  </div>
                ))}
